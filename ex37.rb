...
Data Types
For data types, write out what makes up each one.
For example, with strings write out how you create a string.
For numbers write out a few numbers.
...
Find out what they do, and if you still cant figure it out, save it for later.
...
/	Divide:	2 / 4.0 == 0.5
%	Modulus:	2 % 4 == 2
>	Greater_than:	4 > 4 == false
.	Dot_access:	"1".to_i == 1
::	Colon_access:	Module::Class
[]	List_brackets:	[1,2,3,4]
!	Not:	!true == false
<	Less_than:	4 < 4 == false
>	Greater_than:	4 < 4 == false
>=	Greater_than_equal:	4 >= 4 == true
<=	Less_than_equal:	4 <= 4 == true
<=>	Comparison:	4 <=> 4 == 0
==	Equal:	4 == 4 == true
===	Equality:	4 === 4 == true
!=	Not_equal:	4 != 4 == false
...
..	Range_inclusive:	(0..3).to_a == [0, 1, 2, 3]
...	Range_non_inclusive:	(0...3).to_a == [0, 1, 2]
@	Object_scope:	@var ; @@classvar
@@	Class_scope:	@var ; @@classvar
$	Global_scope:	$stdin
